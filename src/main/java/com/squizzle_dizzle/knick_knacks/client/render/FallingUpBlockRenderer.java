package com.squizzle_dizzle.knick_knacks.client.render;
...
public class FallingUpBlockRenderer extends EntityRenderer<FallingUpBlockEntity> {
    private final BlockRenderDispatcher dispatcher;

    public FallingUpBlockRenderer(EntityRendererProvider.Context p_174112_) {
        super(p_174112_);
        this.shadowRadius = 0.5F;
        this.dispatcher = p_174112_.getBlockRenderDispatcher();
    }

    public void render(FallingUpBlockEntity p_114634_, float p_114635_, float p_114636_, PoseStack p_114637_, MultiBufferSource p_114638_, int p_114639_) {
    ...
    public ResourceLocation getTextureLocation(FallingUpBlockEntity p_114632_) {
