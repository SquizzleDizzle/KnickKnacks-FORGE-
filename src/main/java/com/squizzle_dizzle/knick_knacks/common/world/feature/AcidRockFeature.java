...
public class AcidRockFeature extends Feature<AcidRockFeatureConfiguration> {
   ...
   public AcidRockFeature(Codec<AcidRockFeatureConfiguration> p_65153_) {
      super(p_65153_);
   }

   public boolean place(FeaturePlaceContext<AcidRockFeatureConfiguration> p_159444_) {
      ...
      AcidRockFeatureConfiguration columnfeatureconfiguration = p_159444_.config();
