...
public class EndBulbDesertBiome {
    public static Biome make() {
        BiomeGenerationSettings.Builder $$0 = (new BiomeGenerationSettings.Builder())
                .addFeature(GenerationStep.Decoration.TOP_LAYER_MODIFICATION, KnickKnacksPlaceFeatureRegistry.END_SAND_PATCH_CEILING.getHolder().get());
