...
public class EndFrozenSpringConfig implements FeatureConfiguration {
   public static final Codec<EndFrozenSpringConfig> CODEC = RecordCodecBuilder.create((p_68139_) -> {
      ...
      })).apply(p_68139_, EndFrozenSpringConfig::new);
   });
   ...
   public EndFrozenSpringConfig(BlockState p_204848_, boolean p_204849_, int p_204850_, int p_204851_, HolderSet<Block> p_204852_) {
